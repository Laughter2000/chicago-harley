...
<div className="flex flex-col  lg:hidden justify-center align-middle bg-cta5 bg-cover h-[290px] w-full  mb-8 p-4 mx-auto">
        <button className="text-white bg-black rounded-lg border-4 border-black text-center h-[61px]  text-md md:text-4xl font-extrabold hover:bg-main hover:text-black w-[50%] tracking-widest mb-[18px] mx-auto">+ GET APPROVED</button>
        <button className="text-white bg-black rounded-lg border-4 border-black text-center h-[61px]  text-md md:text-4xl font-extrabold hover:bg-main hover:text-black w-[50%] tracking-widest mb-[18px] mx-auto">+ VALUE A TRADE</button>
        <button className="text-white bg-black rounded-lg border-4 border-black text-center h-[61px]  text-md md:text-4xl font-extrabold hover:bg-main hover:text-black w-[50%] tracking-widest mx-auto">+ SET EVENT</button>
</div>
    )
}
